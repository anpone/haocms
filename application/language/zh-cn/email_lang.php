...
$lang['email_send_failure_phpmail'] = '无法使用 PHP 的 mail() 函数  您的服务器设定禁止使用此函数传送 E-mail';
$lang['email_send_failure_sendmail'] = '无法使用 PHP sendmail 您的服务器设定禁止使用此方法传送 E-mail';
$lang['email_send_failure_smtp'] = '无法使用 PHP SMTP 您的服务器设定禁止使用此方法传送 E-mail';
$lang['email_sent'] = 'E-mail 成功传送： %s';
$lang['email_no_socket'] = '无法打开 Socket 传送 E-mail，请检查设定';
$lang['email_no_hostname'] = '没有指定 SMTP 服务器的主机名称';
